...
<title>{{$instruction->name}}-马陆葡萄网</title>
<meta name="keywords" content="{{$instruction->meta_keyword}}" />
<meta name="description" content="{{$instruction->meta_description}}" />
@section('content')
    ...
    <div class="news w clearfix">
        <div class="news-l">
            <div class="mainLeft">
                <div class="BreadNav">
                <a href="/">首页</a>&nbsp;/&nbsp;
                <a class="hover" href="/instruction">{{$instruction->name}}</a>
                </div>
                <div class="content">
                    <?php
