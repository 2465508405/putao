            ...
            <div class="row">
                <div class='col-md-12'>
                    <div class="table-responsive">
                        <form class="form-inline" method="post" enctype="multipart/form-data" action="/group/postCreate">
                                        ...
                                        <div class="form-group">
                                            @foreach($actionClassify as $classify)
                                                ...
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" id="inlineCheckbox1" name="actions[]" value="{{$action->id}}"> {{$action->name}}
                                                </label>
                                                @endforeach
                                            @endforeach
                                        </div>
