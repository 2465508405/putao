                ...
                <div class="col-md-12">
                    <div class="panel panel-warning">
                        <div class="panel-heading">
                            <a href="/perm/classify/add"><button class="btn btn-success btn-xs pull-right">
                ...
                <div class='col-md-12'>
                    <div class="table-responsive">
                        <table class="table table-bordered table-condensed table-hover">
                            ...
                            @foreach($actionsClassify as $action)
                                <tr>
                                    <td>{{$action->id}}</td>
                                    <td>{{$action->name}}</td>
                                    <td><a href="">删除</a>/<a href="/perm/classify/edit?id={{$action->id}}">修改</a></td>
                                </tr>
                            @endforeach
                        </table>
                    </div>
