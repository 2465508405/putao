            ...
            <div class="row">
                <div class='col-md-12'>
                    <div class="table-responsive">
                        <form class="form-inline" method="post" enctype="multipart/form-data" action="/link/postCreate">
                            {{csrf_field()}}
                            <table class="table table-condensed table-add">
                                ...
                                <tr>
                                    ...
                                    <td style="width:90%;">
                                        <div class="form-group">                                                                <input type="text" name="url" class="form-control" id="inputPassword2" placeholder="链接地址">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
