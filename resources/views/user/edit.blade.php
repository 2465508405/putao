            ...
            <div class="row">
                <div class='col-md-12'>
                    <div class="table-responsive">
                        <form class="form-inline" method="post" enctype="multipart/form-data" action="/user/postEdit">
                            <table class="table table-condensed table-add">
                                ...
                                <tr>
                                    ...
                                    <td style="width:90%;">
                                        <div class="form-group">                                                                <input type="text" value="{{$user->name}}" class="form-control" id="inputPassword2" name="name" placeholder="用户名">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width:90%;">
                                        <div class="form-group">                                                                <input type="text" class="form-control" id="inputPassword2" name="email" value="{{$user->email}}" placeholder="邮箱">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
