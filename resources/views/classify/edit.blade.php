    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <div class="nav-search" id="nav-search">
                <form class="form-search" action="/classify/postEdit" method="post">
        ...
        <div class="page-content">
            <div class="page-content-area">
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form" action="/classify/postEdit" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" placeholder="输入部门名称" name="name" value="{{$articleClass->name}}" class="col-xs-10 col-sm-5" />
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" placeholder="输入部门名称" name="weight" value="{{$articleClass->weight}}" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            <div class="space-4"></div>
                            <div class="form-group">
                                ...
                                <div class="radio col-sm-9">
                                    <label>
                                        <input name="show" class="ace" type="radio" value="1" <?php if($articleClass->show == 1){ echo 'checked';}?> >
                                ...
                                <div class="radio col-sm-9">
                                    <label>
                                        <input name="show" class="ace" type="radio" value="0" <?php if($articleClass->show == 0){ echo'checked';}?> >
